...
Vagrant.configure(2) do |config|
  ...
  #
  # READ - you may need https://github.com/vovimayhem/vagrant-guest_ansible
  # its easy, just run this in the console/powershell: vagrant plugin install vagrant-guest_ansible
  #
end
